...
public class ReceiveKeyWordMessageService implements ServletContextListener {
    ...
    public static void main(String args[]){
        ReceiveKeyWordMessageService test = new ReceiveKeyWordMessageService();
        test.init();
    }
    ...
    public void contextInitialized(ServletContextEvent sce) {
        new ReceiveKeyWordMessageService().init();
    }
    ...
    class ReadTask extends Thread {
        ...
        private void handleMessage(String message) throws UnsupportedEncodingException {
            ...
            if(StringUtils.isBlank(rs.getString("errorCode"))){
                ...
                service.receiveKeyWordMessage(message);
            }else{
