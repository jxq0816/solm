...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public List<User> findUserByWeiBoUserId(User user){
		List<User> list = userDao.findUserByWeiBoUserId(user);
		return list;
	}
	/**
	...
	public List<User> findUserByOfficeIdAndUserType(User user) {
		List<User>	list = userDao.findUserByOfficeIdAndUserType(user);
		return list;
	}
