...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/nms/crisisDispose/countNum">危机数据处理总量统计</a></li>
    <li class="active"><a href="${ctx}/nms/crisisDispose/monthCnt">危机数据处理月统计</a></li>
</ul>
<form:form id="searchForm" modelAttribute="crisisDispose" action="${ctx}/nms/crisisDispose/monthCnt" method="post"
